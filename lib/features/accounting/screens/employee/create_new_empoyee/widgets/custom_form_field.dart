...
class _CustomFormFieldState extends State<CustomFormField> {
  ...
  Color get _lineColor {
    ...
    if (_focusNode.hasFocus) return Colors.grey.shade600; // clicked in
    if (_isHovering) return Colors.grey.shade400;          // hovering
    if (_hasText) return Colors.grey.shade400;             // ✅ has content — stays visible after mouse leaves
    return Colors.transparent;                             // idle, empty, no hover
  }

  double get _lineWidth => _focusNode.hasFocus ? 1.5 : 1;
