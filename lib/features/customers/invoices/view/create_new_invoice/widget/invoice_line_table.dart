...
class InvoiceLineTable extends StatelessWidget {
  const InvoiceLineTable({super.key});
  ...
  Widget build(BuildContext context) {
    final controller = Get.find<CreateInvoiceController>(); // ✅ borrow the controller
      ...
      children: [
        ...
        Obx(() {
          return Table(
            ...
            children: [
              _buildHeaderRow(controller.invoiceHeaderLabels),
  ...
  TableRow _buildDataRow(CreateInvoiceController controller, int i) {
      ...
      children: [
        ...
        Padding(
         ...
         Padding(
          ...
          child: CustomFormField(
            ...
            isTable: true,
            hint: "0.00",
            onChanged: (value) => controller.updatePrice(i, value),
          ),
        ),
        Padding(
          padding: cellPadding,
          child: SearchableDropdownField<TaxModel>(
            items: controller.taxModel,
            labelBuilder: (a) => a.name,
            hintText: "17%",
            isTable: true,
            selectedItem: line.tax,
            onSelected: (value) => controller.updateTaxes(i, value),
          ),
        ),
        ...
        Padding(
          ...
          child: CustomFormField(
            ...
            isTable: true,
            hint: "0.00",
            onChanged: (value) => controller.updateAmount(i, value),
          ),
        ),
